...
let textColor=props.mode==='light'?'dark':'light'
    return (
        ...
        <div className="container my-3 ">
            ...
            <button className="btn btn-primary my-1 mx-2" onClick={convertToUppercase}>convert to uppercase</button>
            <button className="btn btn-primary my-1 mx-2" onClick={convertToLowercase}>convert to lowercase</button>
            <button className="btn btn-primary my-1 mx-2" onClick={capitalizeFirstChar}>capitalize first letter</button>
            <button className="btn btn-primary my-1 mx-2" onClick={copyToClipboard}>copy to clipboard</button>
            <button className="btn btn-primary my-1 mx-2" onClick={clearBtn}>clear</button>
        </div>
